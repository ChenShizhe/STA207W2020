...
This file contains code and comments in STA 207. Note that this document
containss only the outline of the in-class discussion, except for data
analysis. Many materials in this document are adapted based on lectures
by Professors Prabir Burman, Peng Ding, and Kosuke Imai.
...
\item
  Students gain basic familiarity to the potential outcome framework.
\item
