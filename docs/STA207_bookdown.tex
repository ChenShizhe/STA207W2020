...
\NormalTok{  diff.sd[i]=}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{sum}\NormalTok{(comb.mat[i,]}\OperatorTok{^}\DecValTok{2}\OperatorTok{/}\NormalTok{ns)}\OperatorTok{*}\NormalTok{mse);}
\NormalTok{\}}
...
\CommentTok{# Draw the interaction plot:}
...
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-11-1.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Analysis, w/o stratification }

\NormalTok{lm.vanilla=}\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Y}\OperatorTok{~}\NormalTok{Z));}
\NormalTok{lm.X=}\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Y}\OperatorTok{~}\NormalTok{Z}\OperatorTok{+}\NormalTok{X));}

\KeywordTok{plot}\NormalTok{(}\DataTypeTok{y=}\NormalTok{Y,}\DataTypeTok{x=}\NormalTok{X,}\DataTypeTok{pch=}\DecValTok{16}\NormalTok{,}\DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{'red'}\NormalTok{,}\StringTok{'blue'}\NormalTok{)[Z}\OperatorTok{+}\DecValTok{1}\NormalTok{])}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x=}\FloatTok{1.1}\NormalTok{,}\DataTypeTok{y=}\DecValTok{22}\NormalTok{,}\DataTypeTok{legend=}\KeywordTok{c}\NormalTok{(}\StringTok{'Trt'}\NormalTok{,}\StringTok{'Ctrl'}\NormalTok{),}\DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{'red'}\NormalTok{,}\StringTok{'blue'}\NormalTok{),}\DataTypeTok{pch=}\DecValTok{16}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x=}\FloatTok{5.1}\NormalTok{,}\DataTypeTok{y=}\DecValTok{5}\NormalTok{,}\DataTypeTok{labels=}\KeywordTok{paste}\NormalTok{(}\StringTok{'Without X, Est. ACE = '}\NormalTok{,}\KeywordTok{round}\NormalTok{(lm.vanilla}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{), }\StringTok{'with s.e.'}\NormalTok{, }\KeywordTok{round}\NormalTok{(lm.vanilla}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{),}\DataTypeTok{sep=}\StringTok{' '}\NormalTok{  ),}\DataTypeTok{pos=}\DecValTok{4}\NormalTok{  )}

\KeywordTok{text}\NormalTok{(}\DataTypeTok{x=}\FloatTok{5.1}\NormalTok{,}\DataTypeTok{y=}\DecValTok{2}\NormalTok{,}\DataTypeTok{labels=}\KeywordTok{paste}\NormalTok{(}\StringTok{'With X,  Est. ACE = '}\NormalTok{,}\KeywordTok{round}\NormalTok{(lm.X}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{), }\StringTok{'with s.e.'}\NormalTok{, }\KeywordTok{round}\NormalTok{(lm.X}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{),}\DataTypeTok{sep=}\StringTok{' '}\NormalTok{  ),}\DataTypeTok{pos=}\DecValTok{4}\NormalTok{  )}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{STA207_bookdown_files/figure-latex/fig-nostrat-1} 

}

\caption{Estimation of ACE with and without adjusting for X}\label{fig:fig-nostrat}
\end{figure}

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{# Analysis, w stratification }

\NormalTok{lm.simple=}\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Y.s}\OperatorTok{~}\NormalTok{Z.s));}
\NormalTok{lm.strat=}\KeywordTok{summary}\NormalTok{(}\KeywordTok{lm}\NormalTok{(Y.s}\OperatorTok{~}\NormalTok{Z.s}\OperatorTok{+}\NormalTok{X));}

\KeywordTok{plot}\NormalTok{(}\DataTypeTok{y=}\NormalTok{Y.s,}\DataTypeTok{x=}\NormalTok{X,}\DataTypeTok{pch=}\DecValTok{16}\NormalTok{,}\DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{'red'}\NormalTok{,}\StringTok{'blue'}\NormalTok{)[Z.s}\OperatorTok{+}\DecValTok{1}\NormalTok{])}
\KeywordTok{legend}\NormalTok{(}\DataTypeTok{x=}\FloatTok{1.1}\NormalTok{,}\DataTypeTok{y=}\DecValTok{22}\NormalTok{,}\DataTypeTok{legend=}\KeywordTok{c}\NormalTok{(}\StringTok{'Trt'}\NormalTok{,}\StringTok{'Ctrl'}\NormalTok{),}\DataTypeTok{col=}\KeywordTok{c}\NormalTok{(}\StringTok{'red'}\NormalTok{,}\StringTok{'blue'}\NormalTok{),}\DataTypeTok{pch=}\DecValTok{16}\NormalTok{)}
\KeywordTok{text}\NormalTok{(}\DataTypeTok{x=}\FloatTok{5.1}\NormalTok{,}\DataTypeTok{y=}\DecValTok{5}\NormalTok{,}\DataTypeTok{labels=}\KeywordTok{paste}\NormalTok{(}\StringTok{'Without X, Est. ACE = '}\NormalTok{,}\KeywordTok{round}\NormalTok{(lm.simple}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{), }\StringTok{'with s.e.'}\NormalTok{, }\KeywordTok{round}\NormalTok{(lm.simple}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{),}\DataTypeTok{sep=}\StringTok{' '}\NormalTok{  ),}\DataTypeTok{pos=}\DecValTok{4}\NormalTok{  )}

\KeywordTok{text}\NormalTok{(}\DataTypeTok{x=}\FloatTok{5.1}\NormalTok{,}\DataTypeTok{y=}\DecValTok{2}\NormalTok{,}\DataTypeTok{labels=}\KeywordTok{paste}\NormalTok{(}\StringTok{'With X,  Est. ACE = '}\NormalTok{,}\KeywordTok{round}\NormalTok{(lm.strat}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],}\DecValTok{2}\NormalTok{), }\StringTok{'with s.e.'}\NormalTok{, }\KeywordTok{round}\NormalTok{(lm.strat}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{2}\NormalTok{],}\DecValTok{2}\NormalTok{),}\DataTypeTok{sep=}\StringTok{' '}\NormalTok{  ),}\DataTypeTok{pos=}\DecValTok{4}\NormalTok{  )}
\end{Highlighting}
\end{Shaded}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{STA207_bookdown_files/figure-latex/fig-strat-1} 
...
\NormalTok{est.ACE=}\KeywordTok{c}\NormalTok{(lm.vanilla}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],lm.X}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],lm.simple}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{],lm.strat}\OperatorTok{$}\NormalTok{coef[}\DecValTok{2}\NormalTok{,}\DecValTok{1}\NormalTok{])}
\KeywordTok{return}\NormalTok{(est.ACE)}
\NormalTok{\}}
\NormalTok{ACE=}\DecValTok{4}\NormalTok{;}

\NormalTok{sim.result=}\KeywordTok{replicate}\NormalTok{(}\DataTypeTok{n=}\FloatTok{1e4}\NormalTok{,}\KeywordTok{strat.sim}\NormalTok{(}\DataTypeTok{ACE=}\NormalTok{ACE));}
\end{Highlighting}
\end{Shaded}

\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\DataTypeTok{mse=}\KeywordTok{apply}\NormalTok{(sim.result}\OperatorTok{-}\NormalTok{ACE,}\DataTypeTok{MARGIN=}\DecValTok{1}\NormalTok{,sd))}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## [1] 4.59 0.32 1.36 0.32
\end{verbatim}
...
{\centering \includegraphics[width=0.8\linewidth]{STA207_bookdown_files/figure-latex/fig-anovaII-m1-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{STA207_bookdown_files/figure-latex/fig-anovaII-m2-1} 
...
{\centering \includegraphics[width=0.8\linewidth]{STA207_bookdown_files/figure-latex/fig-anovaII-i-1} 
...
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-17-1.pdf}
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-17-2.pdf}
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-17-3.pdf}
...
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-18-1.pdf}
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-18-2.pdf}
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-18-3.pdf}
\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-18-4.pdf}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{Rat.growth <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\DataTypeTok{file=}\StringTok{"./data/Growth.csv"}\NormalTok{, }\DataTypeTok{header=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{sep=}\StringTok{","}\NormalTok{)}

\NormalTok{colorpicks =}\StringTok{ }\KeywordTok{rainbow}\NormalTok{(}\DataTypeTok{n=}\KeywordTok{length}\NormalTok{(}\KeywordTok{unique}\NormalTok{(Rat.growth}\OperatorTok{$}\NormalTok{rat)));}
\KeywordTok{with}\NormalTok{(Rat.growth, }\KeywordTok{plot}\NormalTok{(}\DataTypeTok{y=}\NormalTok{weight, }\DataTypeTok{x=}\NormalTok{week,}\DataTypeTok{type=}\StringTok{'p'}\NormalTok{, }\DataTypeTok{pch=}\DecValTok{16}\NormalTok{, }\DataTypeTok{bty=}\StringTok{'l'}\NormalTok{,  }\DataTypeTok{main=}\StringTok{'Raw growth data'}\NormalTok{, }\DataTypeTok{xlab=}\StringTok{'Week'}\NormalTok{, }\DataTypeTok{ylab=}\StringTok{'Weight'}\NormalTok{,}\DataTypeTok{col=}\NormalTok{colorpicks[rat]))}
\ControlFlowTok{for}\NormalTok{(i }\ControlFlowTok{in} \DecValTok{1}\OperatorTok{:}\KeywordTok{length}\NormalTok{(}\KeywordTok{unique}\NormalTok{(Rat.growth}\OperatorTok{$}\NormalTok{rat)))\{}
\NormalTok{  one.rat=Rat.growth[Rat.growth}\OperatorTok{$}\NormalTok{rat}\OperatorTok{==}\NormalTok{i,]}
  \KeywordTok{with}\NormalTok{(one.rat, }\KeywordTok{lines}\NormalTok{(weight, week,}\DataTypeTok{col=}\NormalTok{colorpicks[rat])）}
\ErrorTok{\}}
\CommentTok{# For more thoughts on visualization, see http://www.colbyimaging.com/wiki/statistics/longitudinal-data}
\KeywordTok{legend}\NormalTok{(}\StringTok{'bottomright'}\NormalTok{, }\DataTypeTok{col=}\NormalTok{colorpicks, }\DataTypeTok{pch=}\KeywordTok{c}\NormalTok{(}\DecValTok{16}\NormalTok{), }\DataTypeTok{legend=}\KeywordTok{paste}\NormalTok{(}\StringTok{'Rat'}\NormalTok{, }\KeywordTok{unique}\NormalTok{(Rat.growth}\OperatorTok{$}\NormalTok{rat)))}
\end{Highlighting}
\end{Shaded}

\includegraphics{STA207_bookdown_files/figure-latex/unnamed-chunk-21-1.pdf}
