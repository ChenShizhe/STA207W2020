...
To test the null hypothesis $H_0: \mu_1=\mu_2=\mu_3=\mu_4$ against the alternative $H_1:$ not all $\mu_i$'s are equal. We can calculate the F-statistics $F^*=\frac{MSTR}{MSE}=$ `r F.stat=(mstr/mse)`, $F(0.95;3,29)=$ `r qf(0.95,dim(Spock)[1]-1-anova.fit$df.residual,anova.fit$df.residual)`.
