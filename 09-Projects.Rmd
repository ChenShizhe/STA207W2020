...
3.  Write down a one-way ANOVA model to study the effects of class types on scores. Explain your notation. 
...
7.  Test whether there is a difference in the math scaled score in kindergarten across students in different class types. Justify your choice of test. 
